...
- (instancetype)init {
    ...
    if (self) {
        CPAAppearanceSettings* appearanceSettings = [[CPAAppearanceSettings alloc] init];
        self.hb_appearanceSettings = appearanceSettings;
        self.enableSwitch = [[UISwitch alloc] init];
        self.enableSwitch.onTintColor = [UIColor colorWithRed: 0.59 green: 0.16 blue: 0.58 alpha: 1.00];
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/CopypastaPrefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/CopypastaPrefs.bundle/Banner.png"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationController.navigationController.navigationBar.barTintColor = [UIColor colorWithRed: 0.21 green: 0.02 blue: 0.21 alpha: 1.00];
...
- (void)toggleState {
    ...
    NSString* path = [NSString stringWithFormat:@"/var/mobile/Library/Preferences/love.litten.copypastapreferences.plist"];
    NSMutableDictionary* dictionary = [NSMutableDictionary dictionaryWithContentsOfFile:path];
    NSSet* allKeys = [NSSet setWithArray:[dictionary allKeys]];
    HBPreferences* preferences = [[HBPreferences alloc] initWithIdentifier: @"love.litten.copypastapreferences"];
    
    if (!([[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.copypastapreferences.plist"])) {
        enabled = YES;
...
- (void)resetPreferences {
    ...
    [[NSFileManager defaultManager] removeItemAtPath:@"/var/mobile/Library/Preferences/love.litten.copypastapreferences/" error:nil];
